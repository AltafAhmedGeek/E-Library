                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" placeholder="Enter Name" runat="server"></asp:TextBox>
                        ...
                        <div class="row">
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" placeholder="+91 8989xxxxxx" runat="server" TextMode="Number"></asp:TextBox>
                   ...
                   placeholder="example@example.com" TextMode="Email"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control"  runat="server" placeholder="Pin Code" TextMode="Number"></asp:TextBox>
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" runat="server" TextMode="MultiLine" Rows="2"></asp:TextBox>
                         ...
                         <div class="row">
                              <div class="col-md-4">
                                       <label>User ID</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" placeholder="User ID" runat="server" ReadOnly="True"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    <asp:TextBox placeholder="Password" CssClass="form-control"  runat="server" TextMode="Password" ReadOnly="True"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    <asp:TextBox placeholder="Password" CssClass="form-control"  runat="server" TextMode="Password"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-md-8 mx-auto">
                               ...
                               <a href="#">
                                ...
                                <input id="Button2" class="btn btn-block btn-primary  btn-lg" type="button" value="Update" />
                               </a>
                                </div>
                                </center>
                            </div>
