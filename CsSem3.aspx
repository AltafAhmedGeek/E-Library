<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CsSem3.aspx.cs" Inherits="E_Library_Management.CsSem3" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            ...
                            <asp:Table runat="server" CssClass="table table-striped table-bordered">
                                ...
                                <asp:TableRow>
                                    <asp:TableCell>Theory of Computation</asp:TableCell>
                                    <asp:TableCell>
                        ...
                        <asp:Button runat="server" Text="Download" CssClass="btn btn-block btn-outline-primary" OnClick="Unnamed5_Click" />
                                ...
                                <asp:TableRow>
                                    <asp:TableCell>Combinatorics and Graph Theory</asp:TableCell>
                                    <asp:TableCell>
                        <asp:Button runat="server" Text="Download" CssClass="btn btn-block btn-outline-primary" OnClick="Unnamed6_Click" />
                                    </asp:TableCell>
                                </asp:TableRow>
                                 <asp:TableRow>
                                    <asp:TableCell>Physical Computing and IoT Programming</asp:TableCell>
                                    <asp:TableCell>
